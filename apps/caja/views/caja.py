...
@method_decorator(
    permission_required("caja.view_caja", raise_exception=True), name="dispatch"
)
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("caja.add_caja", raise_exception=True), name="dispatch"
)
class CajaCreateView(CreateView):
    ...
    success_url = reverse_lazy(
        "tesoreria:tesoreria-caja-list"
    )  # Redirige a la lista de cajas después de crear una


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("caja.change_caja", raise_exception=True), name="dispatch"
)
