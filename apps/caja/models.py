...
class TipoMovimiento(models.Model):
    ...
    tipo = models.CharField(
        max_length=10, choices=[("ingreso", "Ingreso"), ("egreso", "Egreso")]
    )
...
class MovimientoCaja(models.Model):
    ...
    movFecha = models.DateField(
        verbose_name="Fecha del Comprobante", blank=True, null=True
    )
...
class MedioPago(models.Model):
    movimientoCaja = models.ForeignKey(
        MovimientoCaja, on_delete=models.PROTECT, blank=True, null=True
    )
