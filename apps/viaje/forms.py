...
class EmbarqueForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {"programacionViaje": "Ruta"}

        widgets = {
            "numAsiento": forms.TextInput(
                attrs={"readonly": True, "value": "0", "class": "estetica"}
            ),
...
class ProgramacionViajeForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"fechaViaje": "Fecha de viaje"}
...
class BuscarViajeForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {"fechaViaje": forms.DateInput(attrs={"type": "date"})}
