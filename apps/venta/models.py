...
class DetalleMov(models.Model):
    movimiento = models.ForeignKey(Movimiento, on_delete=models.PROTECT,blank=True, null=True)
    unidadMedida = models.CharField(max_length=20, choices=[('NIU','Unidad'),('ZZ','Servicio')],default='ZZ')
    cantidad = models.DecimalField(verbose_name='Cantidad',max_digits=5,decimal_places=2, default=1)
