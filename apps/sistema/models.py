...
class Usuario(AbstractUser):
    ...
    agencia = models.ManyToManyField(Agencia, related_name='agencia_usuario', blank=True)
    def __str__(self):
...
class Menu(models.Model):
    ...
    permiso = models.ForeignKey(Permission,on_delete=models.CASCADE,blank=True, null=True)
