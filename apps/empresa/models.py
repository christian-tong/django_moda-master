...
class Asiento(models.Model):
    ...
    numero = models.CharField(verbose_name='Numero de asiento',max_length=2,blank=True,null=True)
    vehiculo = models.ForeignKey(Vehiculo, on_delete = models.CASCADE)
    saltofila = models.BooleanField(default=False)
    estado= models.CharField(max_length=20, null=True,blank=True,choices=Estado,default='libre')
...
class Conductor(models.Model):
    ...
    fechaExpedicion = models.DateField(verbose_name='Fecha de expedición',blank=True,null=True)
    fechaRevalidacion = models.DateField(verbose_name='Fecha de revalidación',blank=True,null=True)
...
class Agencia(models.Model):
    ...
    empresa = models.ForeignKey(Persona, related_name='empresa_agencia', on_delete=models.CASCADE, blank=True, null=True)
    direccion = models.CharField(max_length=255, blank=True, null=True)
    fijo = models.CharField(max_length=9, blank=True, null=True)
    movilUno = models.CharField(verbose_name='Celular',max_length=9, blank=True, null=True)
