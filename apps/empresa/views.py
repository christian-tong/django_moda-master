...
class ConductorList(ListView):
    ...
    def get_queryset(self):
        ...
        if q:
            qs = qs.filter(
                    Q(chofer__denominacion__icontains=q)|
                    Q(chofer__numDoc__icontains=q)
                ).distinct()
...
class ConductorUpdate(UpdateView):    
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            ...
            self.object.fechaExpedicion =  self.object.fechaExpedicion.isoformat() if self.object.fechaExpedicion else self.object.fechaExpedicion
            self.object.fechaRevalidacion =  self.object.fechaRevalidacion.isoformat() if self.object.fechaRevalidacion else self.object.fechaRevalidacion
