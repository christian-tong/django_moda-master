...
class Persona(models.Model):
    ...
    fijo = models.CharField(
        verbose_name="Teléfono fijo", blank=True, null=True, max_length=10
    )
    movilUno = models.PositiveIntegerField(
        verbose_name="Celular", blank=True, null=True
    )
    movilDos = models.PositiveIntegerField(
        verbose_name="Celular2", blank=True, null=True
    )
    correo = models.EmailField(
        verbose_name="Correo", max_length=250, blank=True, null=True
    )
...
class PersonaNatural(models.Model):
    ...
    foto = models.ImageField(
        verbose_name="Foto",
        upload_to=rutaNombreImagen,
        default="persona/default.png",
        blank=True,
    )
    genero = models.CharField(
        verbose_name="Género", max_length=10, choices=GENERO, blank=True, null=True
    )
