...
from django.db.models import IntegerField,DateField, ExpressionWrapper, F,DateTimeField
    ...
    if request.method == 'POST':
        ...
        if request.POST.get('tipoDoc') == str(person.tipoDoc.id):
            ...
            if person.tipoDoc.codigo != '6':
                ...
                form_natural = PersonaNaturalForm(request.POST, request.FILES, instance=person.personanatural)
    ...
    if request.method == 'POST':
        ...
        if datos['tipodoc'] == 'DNI': 
            ...
            if not response['success']:
                ...
                data['denominacion']= f"{response['nat_Nombres']} {response['nat_Ape_Pat']} {response['nat_Ape_Mat']}"
                data['direccion']= ''
